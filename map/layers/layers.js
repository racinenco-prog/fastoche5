...
lyr_line_2.set('fieldLabels', {'fid': 'no label', 'nom': 'no label', });
lyr_poi_3.set('fieldLabels', {'fid': 'no label', 'nom': 'no label', });
lyr_fastoche_4.set('fieldLabels', {'fid': 'no label', 'nom': 'no label', 'surface': 'no label', 'type': 'no label', });
