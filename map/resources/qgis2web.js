...
map.getView().fit([162705.553336, 5409333.647431, 162876.319999, 5409480.095492], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Plan du Fastoche 5</h2>';
        return titleElement;
    })(),
